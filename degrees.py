...
def neighbors_for_person(person_id):
    ...
    # {(m, n) for n in range(2) for m in range(3, 5)} e.x. gratia --> (3, 0), (3, 1), (4, 0), (4, 1)])

    neighbors = {(movie_id, person_id) for movie_id in movie_ids for person_id in movies[movie_id]["stars"]}
